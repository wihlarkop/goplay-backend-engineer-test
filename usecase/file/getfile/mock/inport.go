...
// Source: goplay-backend-engineer-test/usecase/file/getfile (interfaces: Inport)
...
import (
	context "context"
	getfile "goplay-backend-engineer-test/usecase/file/getfile"
	reflect "reflect"
...
func (m *MockInport) Execute(arg0 context.Context, arg1 getfile.InportRequest) (getfile.InportResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Execute", arg0, arg1)
	ret0, _ := ret[0].(getfile.InportResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
