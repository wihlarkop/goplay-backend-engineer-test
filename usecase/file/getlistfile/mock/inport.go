...
// Source: goplay-backend-engineer-test/usecase/file/getlistfile (interfaces: Inport)
...
import (
	context "context"
	getlistfile "goplay-backend-engineer-test/usecase/file/getlistfile"
	reflect "reflect"
...
func (m *MockInport) Execute(arg0 context.Context, arg1 getlistfile.InportRequest) (getlistfile.InportResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Execute", arg0, arg1)
	ret0, _ := ret[0].(getlistfile.InportResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
